...
//    }
    ...
    public ModifierAnnonce() {
        ...
        try {
            ...
            Label dt=new Label("Date Départ");
            
            Slider sldr = new Slider();
            sldr.setProgress((int)AnnonceCovoiturage.getTarif());
            sldr.setMaxValue(20);
            sldr.setMinValue(0);
            sldr.setVertical(false);
            sldr.setEditable(true);
            Label Tarif1= new Label("Tarif Personne: ");
            Label Tarif = new Label(String.valueOf(AnnonceCovoiturage.getTarif()));
            ...
            sldr1.setProgress(AnnonceCovoiturage.getNbrePlaces());
            sldr1.setMaxValue(8);
            sldr1.setMinValue(1);
            ...
            DateDepart.setDate(formatter1.parse(AnnonceCovoiturage.getDate_depart()));
            f = new Form("Modifier Annonce", BoxLayout.y());
        ...
        tb.addMaterialCommandToSideMenu("Mes Annonces", FontImage.MATERIAL_VIEW_LIST, e -> {
         ...
         tb.addMaterialCommandToSideMenu("AJouter Votre Trajet", FontImage.MATERIAL_PLACE, e -> {
          ...
          f.getToolbar().addCommandToRightBar("Retour", null, (ev) -> {
            ...
            f.add(Modifier);
            from.setText(AnnonceCovoiturage.getAdresse_depart());
            to.setText(AnnonceCovoiturage.getAdresse_arrivee());
            ...
            Modifier.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    try {System.out.println("ahla");
                        DateDepart.getText();
                        System.out.println("foufou" + DateDepart.getText());
                        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yy");
                        ...
                        Annonce_covoiturage AnnonceCov = new Annonce_covoiturage(1, AnnonceCovoiturage.getId_annonce(),formatter1.format(date1), null, from.getText(), to.getText(), (Float) Float.parseFloat(Tarif.getText()));
                        
                        AnnonceCovoiturageService CovoiturageService = new AnnonceCovoiturageService();
                        CovoiturageService.EditAnnonce(AnnonceCov);
                        AfficherAnnoncesCovoiturage a=new AfficherAnnoncesCovoiturage();
                        a.getF().show();}
